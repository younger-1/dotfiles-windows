# gh completion -s powershell >> completion-gh.ps1
...
Register-ArgumentCompleter -Native -CommandName 'gh' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'gh' {
            ...
            [CompletionResult]::new('actions', 'actions', [CompletionResultType]::ParameterValue, 'Learn about working with GitHub actions')
            ...
            [CompletionResult]::new('formatting', 'formatting', [CompletionResultType]::ParameterValue, 'Formatting options for JSON data exported from gh')
            ...
            [CompletionResult]::new('run', 'run', [CompletionResultType]::ParameterValue, 'View details about workflow runs')
            ...
            [CompletionResult]::new('workflow', 'workflow', [CompletionResultType]::ParameterValue, 'View details about GitHub Actions workflows')
            break
        }
        'gh;actions' {
            break
        ...
        'gh;issue' {
            ...
            [CompletionResult]::new('transfer', 'transfer', [CompletionResultType]::ParameterValue, 'Transfer issue to another repository')
        ...
        'gh;issue;list' {
            ...
            [CompletionResult]::new('-q', 'q', [CompletionResultType]::ParameterName, 'Filter JSON output using a jq `expression`')
            [CompletionResult]::new('--jq', 'jq', [CompletionResultType]::ParameterName, 'Filter JSON output using a jq `expression`')
            [CompletionResult]::new('--json', 'json', [CompletionResultType]::ParameterName, 'Output JSON with the specified `fields`')
            ...
            [CompletionResult]::new('-S', 'S', [CompletionResultType]::ParameterName, 'Search issues with `query`')
            [CompletionResult]::new('--search', 'search', [CompletionResultType]::ParameterName, 'Search issues with `query`')
            ...
            [CompletionResult]::new('-t', 't', [CompletionResultType]::ParameterName, 'Format JSON output using a Go template')
            [CompletionResult]::new('--template', 'template', [CompletionResultType]::ParameterName, 'Format JSON output using a Go template')
        ...
        'gh;pr;list' {
            ...
            [CompletionResult]::new('-S', 'S', [CompletionResultType]::ParameterName, 'Search pull requests with `query`')
            [CompletionResult]::new('--search', 'search', [CompletionResultType]::ParameterName, 'Search pull requests with `query`')
        ...
        'gh;run' {
            [CompletionResult]::new('download', 'download', [CompletionResultType]::ParameterValue, 'Download artifacts generated by a workflow run')
            [CompletionResult]::new('list', 'list', [CompletionResultType]::ParameterValue, 'List recent workflow runs')
            [CompletionResult]::new('rerun', 'rerun', [CompletionResultType]::ParameterValue, 'Rerun a failed run')
            [CompletionResult]::new('view', 'view', [CompletionResultType]::ParameterValue, 'View a summary of a workflow run')
            [CompletionResult]::new('watch', 'watch', [CompletionResultType]::ParameterValue, 'Watch a run until it completes, showing its progress')
            break
        }
        'gh;run;download' {
            [CompletionResult]::new('-D', 'D', [CompletionResultType]::ParameterName, 'The directory to download artifacts into')
            [CompletionResult]::new('--dir', 'dir', [CompletionResultType]::ParameterName, 'The directory to download artifacts into')
            [CompletionResult]::new('-n', 'n', [CompletionResultType]::ParameterName, 'Only download artifacts that match any of the given names')
            [CompletionResult]::new('--name', 'name', [CompletionResultType]::ParameterName, 'Only download artifacts that match any of the given names')
            break
        }
        'gh;run;list' {
            [CompletionResult]::new('-L', 'L', [CompletionResultType]::ParameterName, 'Maximum number of runs to fetch')
            [CompletionResult]::new('--limit', 'limit', [CompletionResultType]::ParameterName, 'Maximum number of runs to fetch')
            [CompletionResult]::new('-w', 'w', [CompletionResultType]::ParameterName, 'Filter runs by workflow')
            [CompletionResult]::new('--workflow', 'workflow', [CompletionResultType]::ParameterName, 'Filter runs by workflow')
            break
        }
        'gh;run;rerun' {
            break
        ...
        'gh;run;view' {
            [CompletionResult]::new('--exit-status', 'exit-status', [CompletionResultType]::ParameterName, 'Exit with non-zero status if run failed')
            [CompletionResult]::new('-j', 'j', [CompletionResultType]::ParameterName, 'View a specific job ID from a run')
            [CompletionResult]::new('--job', 'job', [CompletionResultType]::ParameterName, 'View a specific job ID from a run')
            [CompletionResult]::new('--log', 'log', [CompletionResultType]::ParameterName, 'View full log for either a run or specific job')
            [CompletionResult]::new('--log-failed', 'log-failed', [CompletionResultType]::ParameterName, 'View the log for any failed steps in a run or specific job')
            [CompletionResult]::new('-v', 'v', [CompletionResultType]::ParameterName, 'Show job steps')
            [CompletionResult]::new('--verbose', 'verbose', [CompletionResultType]::ParameterName, 'Show job steps')
            [CompletionResult]::new('-w', 'w', [CompletionResultType]::ParameterName, 'Open run in the browser')
            [CompletionResult]::new('--web', 'web', [CompletionResultType]::ParameterName, 'Open run in the browser')
            break
        }
        'gh;run;watch' {
            [CompletionResult]::new('--exit-status', 'exit-status', [CompletionResultType]::ParameterName, 'Exit with non-zero status if run fails')
        ...
        'gh;workflow' {
            [CompletionResult]::new('disable', 'disable', [CompletionResultType]::ParameterValue, 'Disable a workflow')
            [CompletionResult]::new('enable', 'enable', [CompletionResultType]::ParameterValue, 'Enable a workflow')
            [CompletionResult]::new('list', 'list', [CompletionResultType]::ParameterValue, 'List workflows')
            [CompletionResult]::new('run', 'run', [CompletionResultType]::ParameterValue, 'Run a workflow by creating a workflow_dispatch event')
            [CompletionResult]::new('view', 'view', [CompletionResultType]::ParameterValue, 'View the summary of a workflow')
            break
        }
        'gh;workflow;disable' {
            break
        ...
        'gh;workflow;list' {
            [CompletionResult]::new('-a', 'a', [CompletionResultType]::ParameterName, 'Show all workflows, including disabled workflows')
            [CompletionResult]::new('--all', 'all', [CompletionResultType]::ParameterName, 'Show all workflows, including disabled workflows')
            [CompletionResult]::new('-L', 'L', [CompletionResultType]::ParameterName, 'Maximum number of workflows to fetch')
            [CompletionResult]::new('--limit', 'limit', [CompletionResultType]::ParameterName, 'Maximum number of workflows to fetch')
            break
        }
        'gh;workflow;run' {
            [CompletionResult]::new('-F', 'F', [CompletionResultType]::ParameterName, 'Add a string parameter in `key=value` format, respecting @ syntax')
            [CompletionResult]::new('--field', 'field', [CompletionResultType]::ParameterName, 'Add a string parameter in `key=value` format, respecting @ syntax')
            [CompletionResult]::new('--json', 'json', [CompletionResultType]::ParameterName, 'Read workflow inputs as JSON via STDIN')
            [CompletionResult]::new('-f', 'f', [CompletionResultType]::ParameterName, 'Add a string parameter in `key=value` format')
            [CompletionResult]::new('--raw-field', 'raw-field', [CompletionResultType]::ParameterName, 'Add a string parameter in `key=value` format')
            [CompletionResult]::new('-r', 'r', [CompletionResultType]::ParameterName, 'The branch or tag name which contains the version of the workflow file you''d like to run')
            [CompletionResult]::new('--ref', 'ref', [CompletionResultType]::ParameterName, 'The branch or tag name which contains the version of the workflow file you''d like to run')
            break
        }
        'gh;workflow;view' {
            [CompletionResult]::new('-r', 'r', [CompletionResultType]::ParameterName, 'The branch or tag name which contains the version of the workflow file you''d like to view')
            [CompletionResult]::new('--ref', 'ref', [CompletionResultType]::ParameterName, 'The branch or tag name which contains the version of the workflow file you''d like to view')
            [CompletionResult]::new('-w', 'w', [CompletionResultType]::ParameterName, 'Open workflow in the browser')
            [CompletionResult]::new('--web', 'web', [CompletionResultType]::ParameterName, 'Open workflow in the browser')
            [CompletionResult]::new('-y', 'y', [CompletionResultType]::ParameterName, 'View the workflow yaml file')
            [CompletionResult]::new('--yaml', 'yaml', [CompletionResultType]::ParameterName, 'View the workflow yaml file')
            break
        }
    })
